...
#define ADC6_hallC_Pin GPIO_PIN_0
#define ADC6_hallC_GPIO_Port GPIOC
#define ADC77_hallB_Pin GPIO_PIN_1
#define ADC77_hallB_GPIO_Port GPIOC
#define LPUART1_TX_Pin GPIO_PIN_2
#define LPUART1_TX_GPIO_Port GPIOA
#define LPUART1_RX_Pin GPIO_PIN_3
#define LPUART1_RX_GPIO_Port GPIOA
#define ACD15_hallA_Pin GPIO_PIN_0
#define ACD15_hallA_GPIO_Port GPIOB
#define T_SWDIO_Pin GPIO_PIN_13
#define T_SWDIO_GPIO_Port GPIOA
#define T_SWCLK_Pin GPIO_PIN_14
#define T_SWCLK_GPIO_Port GPIOA
#define output_HALLC_Pin GPIO_PIN_3
#define output_HALLC_GPIO_Port GPIOB
#define output_HALLA_Pin GPIO_PIN_4
